...
const Hero = () => {
  return (
    <div className="px-4  md:px-12 flex flex-col   bg-gradient-to-br from-slate-900 via-slate-950 to-black justify-center  items-center h-[95vh] relative mx-auto text-center">
      <h1 className="text-3xl md:text-[70px]  text-white lg:text-[78px] font-bold max-w-4xl">⚡ Instant Summaries, Zero Effort
      </h1>
      <p className="text-sm mt-2 md:text-base text-center text-white mb-8 max-w-4xl">
        ...
        summarizer. 📌 Save time. Stay sharp. Focus on what matters—without the fluff.

(AI-powered. Lightning-fast. Smarter reading starts here.)
      </p>
